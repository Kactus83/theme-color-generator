...
/***/ "./color-generator/models/value-objects/HexColor.ts":
/*!**********************************************************!*\
  !*** ./color-generator/models/value-objects/HexColor.ts ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, exports) => {

eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.HexColor = void 0;\nvar HexColor = /** @class */ (function () {\n    function HexColor(value) {\n        this.value = value;\n        if (!/^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/.test(value)) {\n            throw new Error('Invalid hex color');\n        }\n    }\n    HexColor.prototype.toString = function () {\n        return this.value;\n    };\n    return HexColor;\n}());\nexports.HexColor = HexColor;\n\n\n//# sourceURL=webpack:///./color-generator/models/value-objects/HexColor.ts?");
